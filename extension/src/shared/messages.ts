...
export type OpenCardCreatorPayload =
  | { mode?: 'create'; panel?: CardCreatorPanel; word: string; sentence: string; sourceUrl: string; sourceTitle: string; trMeaning?: string; usageNote?: string; screenshotDataUrl?: string; sentenceAudioDataUrl?: string }
